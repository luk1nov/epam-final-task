...
<head>
    ...
    <!-- Title -->
    <title><fmt:message key="label.search_order"/></title>
                                ...
                                <form action="/controller" method="GET">
                                    <div class="col-md-3 mb-3 ms-auto">
                                        <div class="input-group">
                                            <input type="text" name="search" placeholder="<fmt:message key="label.search_order_placeholder"/>" class="form-control" id="inputSearchQuery" value="<c:out value="${search}"/>">
