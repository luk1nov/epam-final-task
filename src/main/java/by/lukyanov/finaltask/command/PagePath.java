...
public final class PagePath {
    ...
    public static final String CAR_CATEGORY_PAGE = "pages/product/car-category.jsp";
    ...
    public static final String TO_ADMIN_TO_USER_INFO = "controller?command=admin_to_user_info";
